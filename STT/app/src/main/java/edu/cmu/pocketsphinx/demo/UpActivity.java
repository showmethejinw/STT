...
public class UpActivity extends Activity implements
    ...
    public void onCreate(Bundle state) {
        ...
        WebView01.loadUrl("https://www.youtube.com/watch?v=ix0ishA585o");
    ...
    private void runRecognizerSetup() {
        ...
        new AsyncTask<Void, Void, Exception>() {
            ...
            protected Exception doInBackground(Void... params) {
                try {
                    Assets assets = new Assets(UpActivity.this);
...
//                            .setText("Failed to init recognizer " + result);
    ...
    public void onPartialResult(Hypothesis hypothesis) {
        ...
        {
            recognizer.stop();
            Intent intent = new Intent(UpActivity.this, DownActivity.class);
