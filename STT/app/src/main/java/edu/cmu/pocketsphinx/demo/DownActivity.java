...
public class DownActivity extends Activity implements
    ...
    public void onCreate(Bundle state) {
        ...
        WebView01.loadUrl("http://210.117.31.104:10002/?action=stream");
    ...
    private void runRecognizerSetup() {
        ...
        new AsyncTask<Void, Void, Exception>() {
            ...
            protected Exception doInBackground(Void... params) {
                try {
                    Assets assets = new Assets(DownActivity.this);
...
//                            .setText("Failed to init recognizer " + result);
    ...
    public void onPartialResult(Hypothesis hypothesis) {
        ...
        {
            recognizer.stop();
            Intent intent = new Intent(DownActivity.this, PocketSphinxActivity.class);
